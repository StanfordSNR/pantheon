...
dev_list= "bison cdbs curl dpkg-dev elfutils devscripts fakeroot flex git-core
           ...
           libcurl4-gnutls-dev libdrm-dev libelf-dev libffi-dev libgconf2-dev
           ...
           libudev-dev libwww-perl libxslt1-dev libxss-dev libxt-dev
           libxtst-dev openbox patch perl php5-cgi pkg-config python-cherrypy3
           python-crypto python-dev python-numpy python-opencv python-openssl
           python-psutil python-yaml rpm ruby subversion wdiff zip" 
