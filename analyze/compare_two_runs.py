...
for scheme in common_schemes:
    ...
    throughput_lines.append([scheme, exp1_runs, exp2_runs, 'throughput (Mbit/s)', exp1_throughput_mean, exp2_throughput_mean, get_difference(exp1_throughput_mean, exp2_throughput_mean),
            exp1_throughput_std, exp2_throughput_std, get_difference(exp1_throughput_std, exp2_throughput_std)])
    ...
    delay_lines.append([scheme, exp1_runs, exp2_runs, '95th percentile delay (ms)', exp1_delay_mean, exp2_delay_mean, get_difference(exp1_delay_mean, exp2_delay_mean),
            exp1_delay_std, exp2_delay_std, get_difference(exp1_delay_std, exp2_delay_std)])
...
print tabulate(throughput_lines + delay_lines, headers=output_headers, floatfmt=".2f", stralign="right")
